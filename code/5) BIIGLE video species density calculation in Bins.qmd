...
paste0(wd,"/Output/dist_calibrated_unsmoothed_3d_navigation_flat3.csv" ) %>%  read_csv() -> navigation_data
...
navigation_data %>%
  write_csv(paste0(wd,"/Output/bins_dist_calibrated_unsmoothed_3D_navigation_flat3.csv" ) )
...
arranged_annotations_file <-  paste0(wd,"/annotations/","arranged_annotations_flat3.csv" )
...
```{r}
bins_df %>% 
  write_csv(paste0("../Output/",bin_size,"bins_species_abundances_flat3_3d_unsmoothed.csv"))
```
...
bins_df_density %>% 
  write_csv(paste0(wd,"/Output/",bin_size,"bins_species_densities_flat3_3d_nonsmoothing.csv"))

### calculate total species density of total transect area
### first calculate total surface from previous calculated average_image_width multiplied with total_distance_travelled value
...
total_df_density  %>% 
  write_csv(paste0(wd,"/Output/","species_densities_flat3_3d_nonsmoothing.csv")) 
