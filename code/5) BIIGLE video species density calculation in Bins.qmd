...
paste0(wd,"/Output/dist_calibrated_smoothed_2d_navigation.csv" ) %>%  read_csv() -> navigation_data
...
navigation_data %>%
  write_csv(paste0(wd,"/Output/bins_dist_calibrated_smoothed_2D_navigation.csv" ) )
...
arranged_annotations_file <-  paste0(wd,"/annotations/","arranged_annotations_flat1.csv" )
...
```{r}
bins_df %>% 
  write_csv(paste0("../Output/",bin_size,"mbins_species_abundances_flat1_smooth_2d.csv"))
```
...
bins_df_density %>% 
  write_csv(paste0(wd,"/Output/",bin_size,"mbins_species_densities_flat1_smooth_2d.csv"))
...
total_df_density  %>% 
  write_csv(paste0(wd,"/Output/","species_densities_flat1_smooth_2d.csv")) 
