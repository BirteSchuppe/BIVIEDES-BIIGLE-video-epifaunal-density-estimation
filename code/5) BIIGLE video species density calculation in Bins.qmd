...
```{r}
bins_df %>% 
  write_csv(paste0("../Output/",bin_size,"bins_species_abundances_annotations.csv"))
```
...
bins_df_density %>% 
  write_csv(paste0(wd,"/Output/",bin_size,"bins_species_densities_annotations.csv"))
...
total_df_density  %>% 
  write_csv(paste0(wd,"/Output/","species_densities_annotations.csv")) 
