...
navigation_data %>%
  write_csv(paste0(wd,"/Output/bins_dist_calibrated_smoothed_3D_navigation.csv" ) )
...
```{r}
bins_df %>% 
  write_csv(paste0("../Output/",bin_size,"bins_species_abundances.csv"))
```
...
bins_df_density %>% 
  write_csv(paste0(wd,"/Output/",bin_size,"bins_species_densities.csv"))
...
total_df_density  %>% 
  write_csv(paste0(wd,"/Output/","species_densities.csv")) 
