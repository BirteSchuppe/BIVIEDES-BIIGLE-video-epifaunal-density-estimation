...
!!! use the video time to merge metdata and navigation data !!! at least checks the start_time is 0 seconds in videos
...
smoothed_navigation_laser_data %>% filter( videotime == 0 ) %>% pull(datetime)
