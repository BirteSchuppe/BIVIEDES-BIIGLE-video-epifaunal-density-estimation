...
### ADDITIONAL: for 2D distance travelled: remove "depth2 = depth" and rename distance_3d to distance_2d. The matrix of distance_2d should be adjusted to this:  distance_2d = # put coordinates into a matrix
           ####matrix(c(X2,Y2,X,Y), ncol = 2, exchange all 3ds with 2ds in codeline 136 and 138
dpoint %>%
